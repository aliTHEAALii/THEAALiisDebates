...
//    @Published var videoID: String = UUID().uuidString
    ...
    func createTIT(
        titName: String, titDescription: String, titThumbnailURL: String?,
        firstTitVideoName: String, firstTitVideoDescription: String, firstVideoThumbnailURL: String?,
                   creatorID: String,
//                   firstvideoID: String,
        firstVideoURL: String) async throws {
            
            //create instances
            //TODO: - Thumbnail & tit name
            let tit = TIModel(id: TITId, name: titName, description: titDescription,
                              thumbnailURLString: titThumbnailURL, creatorUID: creatorID,
                              administratorsUID: [])
            
            //TODO: - Thumbnail & tit name & VideoId
            let titVideo = TIVideoModel(id: videoId, videoURL: firstVideoURL, thumbnail: firstVideoThumbnailURL, creatorID: creatorID, name: firstTitVideoName, description: firstTitVideoDescription, chainLId: nil)
            
            let titChainLink = TITChainLinkModel(id: UUID().uuidString, videoID: titVideo.id, responseList: [])
