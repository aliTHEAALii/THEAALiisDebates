...
struct VideoSV_Previews: PreviewProvider {
    static var previews: some View {
        ...
        VotingVideoCard(tiID: "i", tiChainLId: "cid", tiVideoID: "v", tiVideo: TestingComponents().titVideo, order: 3, isAdmin: true)
        TIVideoPlayerSV(tiVideo: .constant(TestingComponents().titVideo), urlString: "", sf: 0.85)
