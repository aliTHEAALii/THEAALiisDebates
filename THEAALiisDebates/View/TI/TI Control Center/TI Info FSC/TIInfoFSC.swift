        ...
        VStack() {
            ...
            ScrollView(showsIndicators: false) {
                ...
                HStack(spacing: 0) {
                    ...
                    UserButton(userID: ti.creatorUID)
                }
...
struct TIInfoFSC_Previews: PreviewProvider {
    static var previews: some View {
        TIInfoButton(ti: .constant(TestingComponents().testingTIT))
        
        TIInfoFSC(ti: .constant(TestingComponents().testingTIT), showTIInfoFSC: .constant(true))
    }
}
