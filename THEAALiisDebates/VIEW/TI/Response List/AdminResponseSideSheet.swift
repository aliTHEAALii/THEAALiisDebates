...
struct AdminResponseSideSheet_Previews: PreviewProvider {
    static var previews: some View {
        AdminResponseSideSheet(tiId: "id", tiChainLId: "cid", tiVideo: TestingModels().titVideo, isAdmin: true, showSideSheet: .constant(true))
            .preferredColorScheme(.dark)
        
        AdminOptions(tiId: "whatever", tiChainLId: "cid", tiVideo: TestingModels().titVideo, isAdmin: true)
            .preferredColorScheme(.dark)
    }
}
